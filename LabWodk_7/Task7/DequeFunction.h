...
void WriteToFile(Deque *deque); // Записать дек в файл
void ReadFromFile(Deque *deque); // Считать дек из файла

void InputElements(Deque *deque); // Добавление элементов массивом